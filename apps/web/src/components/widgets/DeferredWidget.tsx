...
export type DeferredWidgetProps = {
  type: string;
  consumerKey?: string;
...
export default function DeferredWidget({
  ...
  switch (type) {
    case "calendar-today":
      return <CalendarTodayWidget className={className} {...properties} />;

    case "calendar-week":
      return <CalendarWeekWidget className={className} {...properties} />;
    ...
    case "latest-rss-feed":
      return <RssFeedWidgetWrapper className={className} {...properties} />;

    case "latest-links":
      return <LatestLinksWidgetWrapper className={className} {...properties} />;

    case "countdown":
      return <CountdownWidget className={className} {...properties} />;

    case "link-view":
      return <LinkView />;

    case "iframe":
      return <IframeWidget className={className} params={properties} />;
